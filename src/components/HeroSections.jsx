  ...
  return (
    <div id='home' name='home' className=' min-h-[400px] flex justify-center pt-20 '>
      <div className=' max-w-[90%] flex flex-col items-center gap-7 justify-center py-10 max-lg:w-full  max-md:w-full '>
        ...
        <p className=' text-center text-lg max-md:text-lg  text-wrap '>I love working on web applications using technologies like React, Tailwind, Node.js, Express.js, and MongoDB.</p>
        <Link href={'#project'}  ><Button className=' uppercase ' size='lg' >Projects</Button></Link>
